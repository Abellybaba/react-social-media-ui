...
const RightBar = () => {
  return (
    <div className="hidden lg:block max-h-screen sticky-top overflow-scroll p-5 max-w-lg bg-gray-100" style={{ flex: 3 }}>
      {/* First Suggestion section on the right bar */}
      <div className="mt-14 container h-60 bg-slate-50 rounded shadow-lg overflow-auto">
      <h4 className="text-gray-500 p-2 ml-3 mt-3">Latest Activities</h4>
        <div className="px-3">
          ...
          <div className="flex justify-between align-center p-2 border-b">
            <div className="flex items-center">
              ...
              <span className='text-sm ml-3'>Able Abelly</span>
            </div>
            <div className="">
      ...
      <div className="mt-5 container h-60 bg-slate-50 rounded shadow-lg overflow-auto">
      <h4 className="text-gray-500 p-2 ml-3 mt-3">Latest Activities</h4>
        <div className="px-3">
      ...
      <div className="mt-5 container h-60 bg-slate-50 rounded shadow-lg overflow-auto">
      <h4 className="text-gray-500 p-2 ml-3 mt-3">Online Friends</h4>
        <div className="px-3"> 
